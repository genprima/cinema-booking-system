...
public class SecurityConfig {
    ...
    public EmailAuthenticationFilter emailAuthenticationFilter(
            ...
            @Qualifier("emailAuthenticationFailureHandler") AuthenticationFailureHandler failureHandler,
    ...
    @Bean("emailAuthenticationFailureHandler")
    public AuthenticationFailureHandler emailAuthenticationFailureHandler() {
